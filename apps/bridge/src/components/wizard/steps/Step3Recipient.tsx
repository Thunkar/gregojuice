import { Box, TextField, Button, IconButton, ToggleButtonGroup, ToggleButton } from "@mui/material";
  ...
  return (
    <>
          ...
          <TextField
            ...
            helperText={
              i === 0 && recipients.length === 1
                ? "The Aztec L2 address that will receive the fee juice"
                : undefined
            }
          />
      ...
      {!readOnly && recipients.length < MAX_RECIPIENTS && (
        <Button size="small" startIcon={<AddIcon />} onClick={addRow} sx={{ mb: 1 }}>
          Add recipient
        </Button>
      )}
    </>
