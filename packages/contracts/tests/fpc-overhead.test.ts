...
describe("FPC gas overhead", () => {
  beforeAll(async () => {
    ...
    await token.methods
      ...
      .send({ from: ctx.admin });
    await token.methods
      .mint_to_private(ctx.admin, 100000n)
      .send({ from: ctx.admin });
    await token.methods
      .mint_to_private(userAddress, 100000n)
      .send({ from: ctx.admin });
  ...
  it("captured constants match measured values", () => {
    ...
    if (
      ...
      console.log(
        `  export const FPC_SUBSCRIBE_OVERHEAD_L2_GAS = ${measuredSubscribeL2};`,
      );
      console.log(
        `  export const FPC_SUBSCRIBE_OVERHEAD_DA_GAS = ${measuredSubscribeDA};`,
      );
      console.log(
        `  export const FPC_SPONSOR_OVERHEAD_L2_GAS = ${measuredSponsorL2};`,
      );
      console.log(
        `  export const FPC_SPONSOR_OVERHEAD_DA_GAS = ${measuredSponsorDA};`,
      );
      console.log(
        `  export const FPC_TEARDOWN_L2_GAS = ${measuredTeardownL2};`,
      );
      console.log(
        `  export const FPC_TEARDOWN_DA_GAS = ${measuredTeardownDA};`,
      );
    }
  ...
  it("private repricing is consistent between subscribe and sponsor", () => {
    ...
    // Sponsor repricing
    const sponsorDiffL2 =
      sponsorPrivateGas.gasLimits.l2Gas - standalonePrivateGas.gasLimits.l2Gas;
